...
Route::middleware(['auth', config('jetstream.auth_session'), 'verified'])->prefix('inventory')->group(function () {
    ...
    // Note: keep this ABOVE resource routes to avoid matching {inventory_item}=sample-csv
    Route::get('inventory-items/sample-csv', [InventoryItemController::class, 'downloadSampleCsv'])->name('inventory-items.sample-csv');
