...
<div class="p-4 bg-white block dark:bg-gray-800 dark:border-gray-700 border-b border-gray-200 dark:border-gray-700">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-3">
        <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white leading-tight">
            {{ __('hotel::modules.reservation.editReservation') }} — {{ $reservation->reservation_number }}
        </h1>
...
<div class="p-4">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
        @livewire('hotel::forms.edit-reservation', ['reservationId' => $reservation->id], key('edit-reservation-'.$reservation->id))
    </div>
</div>
