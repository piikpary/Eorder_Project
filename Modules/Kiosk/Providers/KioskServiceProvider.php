...
use Modules\Kiosk\Livewire\Kiosk\KioskSettings;
...
class KioskServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'Kiosk';

    protected string $nameLower = 'kiosk';
    ...
    {
        Livewire::component('kiosk::restaurant.setting', KioskSettings::class);
    }
}
