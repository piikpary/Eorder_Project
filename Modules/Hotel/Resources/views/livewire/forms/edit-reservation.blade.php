            ...
            <div class="lg:w-80 xl:w-96 shrink-0">
                <div class="sticky top-4 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-800">
                    ...
                    <div class="p-4 space-y-4">
                        ...
                        @endif
                        <div>
                            <x-label for="edit_tax_ids" value="{{ __('hotel::modules.reservation.bookingTax') }}" class="!text-sm" />
                            <div class="mt-2 space-y-2">
                                ...
                                <div class="space-y-2 max-h-44 overflow-y-auto pr-1">
                                    ...
                                    <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-200" wire:key="edit-tax-choice-{{ $tax->id }}">
                                        <input type="checkbox"
                                            value="{{ $tax->id }}"
                        ...
                        <div>
                            <x-label for="edit_security_deposit" value="{{ __('hotel::modules.reservation.securityDeposit') }}" class="!text-sm" />
                            <x-input id="edit_security_deposit" type="number" step="0.01" min="0" wire:model.live="security_deposit" class="block mt-1 w-full" />
