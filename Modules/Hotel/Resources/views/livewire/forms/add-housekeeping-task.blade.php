<div>
    <form wire:submit="submitForm">
        ...
        <div class="flex w-full pb-4 space-x-4 mt-6 rtl:space-x-reverse">
            <x-button type="submit" wire:loading.attr="disabled">{{ __('hotel::modules.housekeeping.save') }}</x-button>
            <x-button-cancel type="button" wire:click="$dispatch('hideAddHousekeepingTask')" wire:loading.attr="disabled">{{ __('hotel::modules.housekeeping.cancel') }}</x-button-cancel>
        </div>
    </form>
</div>
