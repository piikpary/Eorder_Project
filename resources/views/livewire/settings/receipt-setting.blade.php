<div>
        ...
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center space-x-3">
                <h3 class="text-xl font-semibold dark:text-white">
                    @lang('modules.settings.receiptSetting')
                </h3>
            </div>
        </div>
        ...
        <form wire:submit="submitForm">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <h4 class="text-base font-medium text-gray-900 dark:text-white">
                                @lang('modules.settings.customerInformation')
                            </h4>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <label for="customerPhone" class="ms-3 flex items-center">
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        @lang('modules.settings.customerPhone')
                                    </span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <label for="showOrderType" class="ms-3 flex items-center">
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        @lang('modules.settings.showOrderType')
                                    </span>
                                </label>
                            </div>
                        </div>
                    ...
                    {{-- Receipt Languages --}}
                    @if (count($availableReceiptLanguages) > 1)
                        <div
                            class="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">

                            <div class="flex items-center justify-between mb-4">
                                <h4 class="text-base font-medium text-gray-900 dark:text-white">
                                    @lang('modules.settings.receiptLanguages')
                                </h4>
                            </div>

                            <div class="space-y-3">
                                @foreach ($availableReceiptLanguages as $languageCode => $languageName)
                                    <label
                                        class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg cursor-pointer">

                                        <x-checkbox
                                            name="receipt_languages_{{ $languageCode }}"
                                            id="receipt_languages_{{ $languageCode }}"
                                            value="{{ $languageCode }}"
                                            wire:model="receiptLanguages"
                                        />

                                        <span class="ms-3 font-medium text-gray-900 dark:text-white">
                                            {{
                                                isset(\App\Models\LanguageSetting::LANGUAGES_TRANS[$languageCode])
                                                    ? \App\Models\LanguageSetting::LANGUAGES_TRANS[$languageCode]
                                                        . ' (' . $languageName . ')'
                                                    : $languageName
                                            }}
                                        </span>
                    ...
                    <div
                        ...
                        <div class="space-y-4">
                            <div>
                                <x-label
                                    for="usdToKhrRate"
                                    value="USD to KHR Exchange Rate"
                                />
                                ...
                                <x-input
                                    ...
                                    wire:model.live.debounce.300ms="usdToKhrRate"
                                    placeholder="4100"
                                />

                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    Example: 1 USD = 4100 KHR
                                </p>
                            ...
                            <div
                                ...
                                <x-checkbox
                                    name="showKhrOnReceipt"
                                    id="showKhrOnReceipt"
                                    wire:model.live="showKhrOnReceipt"
                                />

                                <label for="showKhrOnReceipt" class="ms-3">
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        Show total in Khmer Riel
                                    </span>

                                    <span class="block mt-1 text-xs text-gray-500 dark:text-gray-400">
                                        The original receipt total remains in USD.
                                    </span>
                                </label>
                            </div>

                            <x-input-error
                                for="showKhrOnReceipt"
                                class="mt-2"
                            />
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <h4 class="text-base font-medium text-gray-900 dark:text-white">
                                @lang('modules.settings.restaurantInformation')
                            </h4>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <label for="showRestaurantName" class="ms-3 flex items-center">
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        @lang('modules.settings.showRestaurantName')
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <label for="showBranchName" class="ms-3 flex items-center">
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        @lang('modules.settings.showBranchName')
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <x-checkbox
                                    name="showBranchAddress"
                                    id="showBranchAddress"
                                    wire:model="showBranchAddress"
                                />
                                ...
                                <label for="showBranchAddress" class="ms-3 flex items-center">
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        @lang('modules.settings.showBranchAddress')
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <label for="restaurantTax" class="ms-3 flex items-center">
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        @lang('modules.settings.restaurantTax')
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <label for="showCrNumber" class="ms-3 flex items-center">
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        @lang('modules.settings.showCrNumber')
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <label for="showVatNumber" class="ms-3 flex items-center">
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        @lang('modules.settings.showVatNumber')
                                    </span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div
                        class="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700"
                        x-data="{ qrCodePreview: @entangle('paymentQrCode').defer }">

                        <div class="flex items-center justify-between mb-4">
                            <h4 class="text-base font-medium text-gray-900 dark:text-white">
                                @lang('modules.settings.paymentDetails')
                            </h4>
                        </div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center space-x-6">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="relative h-24 w-24">
                                        ...
                                        <div x-show="qrCodePreview" style="display: none;">
                                            <span
                                                class="block h-24 w-24 rounded-lg bg-cover bg-center bg-no-repeat"
                                                x-bind:style="'background-image: url(' + qrCodePreview + ');'"
                                            ></span>
                                        </div>
                                ...
                                <div class="flex-grow space-y-3">
                                    <input
                                        ...
                                        class="hidden"
                                        accept="image/*"
                                        wire:model.defer="paymentQrCode"
                                        x-ref="paymentQrCode"
                                        x-on:change="
                                            qrCodeName = $refs.paymentQrCode.files[0].name;
                                            const reader = new FileReader();
                                            reader.onload = (e) => {
                                                qrCodePreview = e.target.result;
                                            };
                                            reader.readAsDataURL($refs.paymentQrCode.files[0]);
                                        "
                                    />
                            ...
                            <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <x-checkbox
                                    name="showPaymentQrCode"
                                    id="showPaymentQrCode"
                                ...
                                <label for="showPaymentQrCode" class="ms-3 flex items-center">
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        @lang('modules.settings.showPaymetQrCode')
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <label for="showPaymentDetails" class="ms-3 flex items-center">
                                    ...
                                    >
                                        <path
                                            d="M448 128v320H128V128zm-42.667 42.667H170.667v234.666h234.666zM384 64v42.667l-277.334-.001V384H64V64zm-21.333 234.667v42.666H213.333v-42.666zm0-85.334V256H213.333v-42.667z"
                                            fill-rule="evenodd"
                                            fill="currentColor"
                                        />
                                    </svg>
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        @lang('modules.settings.showPaymentDetails')
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <label for="showPaymentStatus" class="ms-3 flex items-center">
                                    ...
                                    <span class="font-medium text-gray-900 dark:text-white">
                                        @lang('modules.settings.showPaymentStatus')
                                    </span>
                                </label>
                            </div>
                        </div>
                                        ...
                                        <div class="p-6">
                                            <div class="flex items-center justify-between mb-4">
                                                <h3 class="text-lg font-medium">
                                                    @lang('modules.settings.receiptPreview')
                                                </h3>
                                            ...
                                            >
                                                <div class="header">
                                                    ...
                                                    @if (!$showRestaurantName && $showBranchName)
                                                        <div
                                                            ...
                                                            style="margin-top: 0; margin-bottom: 1mm;"
                                                        >
                                                    ...
                                                    @if ($showCrNumber)
                                                        <div class="restaurant-info">
                                                            <span>
                                                                @lang('modules.settings.branchCrNumber')

                                                                @if (count($receiptLanguages) > 1)
                                                                    @lang(
                                                                        'modules.settings.branchCrNumber',
                                                                        [],
                                                                        $receiptLanguages[1]
                                                                    )
                                                                @endif
                                                    ...
                                                    @if ($showVatNumber)
                                                        <div class="restaurant-info">
                                                            <span>
                                                                @lang('modules.settings.branchVatNumber')

                                                                @if (count($receiptLanguages) > 1)
                                                                    @lang(
                                                                        'modules.settings.branchVatNumber',
                                                                        [],
                                                                        $receiptLanguages[1]
                                                                    )
                                                                @endif
                                                    ...
                                                    @if ($customerAddress)
                                                        <div class="summary-row">
                                                            <span>
                                                                ...
                                                                @if (count($receiptLanguages) > 1)
                                                                    @lang(
                                                                        'modules.customer.customerAddress',
                                                                        [],
                                                                        $receiptLanguages[1]
                                                                    )
                                                                @endif
                                                ...
                                                <div class="summary">
                                                    ...
                                                    @if (
    $showKhrOnReceipt &&
    (float) $usdToKhrRate > 0
)
    <div class="summary-row total-khr">
        <span lang="km">
            &#6047;&#6042;&#6075;&#6036;&#6023;&#6070;&#6042;&#6080;&#6043;
        </span>:
    ...
    <div class="summary-row exchange-rate">
        <span lang="km">
            &#6050;&#6031;&#6098;&#6042;&#6070;&#6036;&#6098;&#6031;&#6076;&#6042;&#6036;&#6098;&#6042;&#6070;&#6016;&#6091;
        </span>:
...
@endif
                                                    ...
                                                    @if ($showPaymentStatus)
                                                        <div
                                                            class="summary-row"
                                                            style="margin-top: 10px; padding-top: 10px; border-top: 1px dashed #000;"
                                                        >
                                                ...
                                                <div class="footer">
                                                    ...
                                                    @if ($showPaymentQrCode)
                                                        <p class="mt-4">
                                                            @lang('modules.settings.payFromYourPhone')

                                                            @if (count($receiptLanguages) > 1)
                                                                <br>

                                                                @lang(
                                                                    'modules.settings.payFromYourPhone',
                                                                    [],
                                                                    $receiptLanguages[1]
                                                                )
                                                            @endif
                                                        ...
                                                        <p>
                                                            @lang('modules.settings.scanQrCode')

                                                            @if (count($receiptLanguages) > 1)
                                                                <br>

                                                                @lang(
                                                                    'modules.settings.scanQrCode',
                                                                    [],
                                                                    $receiptLanguages[1]
                                                                )
                                                            @endif
