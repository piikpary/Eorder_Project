        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header pb-3 pt-4 px-5 border-b">
                    <h4 class="card-title text-lg font-semibold mb-1">@lang('superadmin.desktopAndMobileApps')</h4>
                    ...
                    <div class="flex flex-wrap gap-2 mt-4 border-b border-gray-200 dark:border-gray-600 -mb-px">
                        <a href="{{ route('superadmin.superadmin-settings.index').'?tab=desktop-app&subtab=desktop' }}" wire:navigate
                ...
                <div class="card-body p-5">
                    ...
                    <div class="mb-6 flex flex-col md:flex-row gap-6">
                        ...
                        <div class="flex-1 p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 flex flex-col justify-center">
                            <div class="flex flex-col items-center justify-center h-full text-center">
                                ...
                                <p class="text-xs text-gray-600 dark:text-gray-400">Download the official TableTrack Desktop Printing App for direct printing</p>
                            </div>
                        </div>
                        @endif
                    ...
                    <div class="mt-6 my-6">
                        <p class="mt-2 text-sm text-blue-700 dark:text-blue-300 font-medium">@lang('superadmin.desktopApplicationSettingsDescription2')</p>
                    </div>
